...
const NavBar = () => {
    ...
    return (
        <span className={styles.teste}>
            ...
            <Sidebar className={`collapse d-lg-block sidebar collapse bg-green ${styles.sidebar}`}>
            <div id='img' className={styles.logo}>
                ...
                <Menu>
                    <SubMenu component={<Link to="/home" />} label="Gráficos">
                        <MenuItem component={<Link to="/campanhas" />}> Campanhas </MenuItem>
                        <MenuItem component={<Link to="/condominios" />}> Condomínios </MenuItem>
                    </SubMenu>
                    <MenuItem component={<Link to="/voluntarios/cadastro" />}> Colaboradores </MenuItem>
                    <MenuItem component={<Link to="/produtos-unitarios/cadastro" />}> Produtos </MenuItem>
                    <MenuItem component={<Link to="/cestas/cadastro" />}> Cestas </MenuItem>
                    <MenuItem component={<Link to="/condominios/cadastro" />}> Condomínios </MenuItem>
                    <MenuItem component={<Link to="/campanhas/cadastro" />}> Campanhas </MenuItem>
                    <MenuItem component={<Link to="/indicadores/cadastro" />}> Indicadores </MenuItem>
                    <MenuItem component={<Link to="/relatorios" />}> Relatórios </MenuItem>
                </Menu>
            </Sidebar>
        </span>
