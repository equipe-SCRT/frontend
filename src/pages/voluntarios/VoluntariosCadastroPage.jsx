...
const VoluntariosCadastro = () => {
    ...
    try {
      ...
      setVoluntarios(encontrados.data.map((e) => {
        return {
          ...
          "nome": e.nome,
          "email": e.email,
          "tipoUsuario": e.tipoUsuario === 1 ? "Administrador" : "Voluntário"
        }
  ...
  const handleAlterar = (rowData) => {
    var usuarioNovo = {
      ...
      nome: rowData.nome,
      email: rowData.email,
      tipoUsuario: rowData.tipoUsuario === "Administrador" ? 1 : 2
    }
  ...
  function insert() {
    ...
    if (tipoUsuario == 0) {
      _alertaError("Cadastro Inválido!", "Insira um tipo de usuário correto!")
      return
