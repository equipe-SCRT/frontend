            ...
            <div className="d-flex align-items-center h-custom-2 px-5  pt-5 pt-xl-0 mt-xl-n5 w-100 vh-100" >
              ...
              <form id='login-form' className='w-100 '>
                ...
                <div className="form-outline mb-4">
                  ...
                  <input type="text" name="senha" id="iptSenha" placeholder="***********" className="form-control form-control-lg"   />
                ...
                <div className="pt-1 mb-4 row">
                  <button className="btn btn-warning btn-lg btn-block text-light fw-bold" type="button">Sair</button>
                </div>
